import { bind, formatModelIdToString } from './utils';
import AWS from 'aws-sdk';
import nodemailer from 'nodemailer';
import EmailTemplates from 'swig-email-templates';
import config from '../config/awk-ses-config'
...
export default class AwsSES {
  ...
  async sendResetEmail(to , subject, data) {
    try {
      ...
      const path = join(__dirname, '../app/user/templates/password-reset/submit.html');
  ...
  async sendConfirmEmail(to , subject, data) {
    try {
      ...
      const path = join(__dirname, '../app/user/templates/password-reset/confirm.html');
  ...
  async sendThankYouEmailForAdvertisement(to , subject, data = {}) {
    try {
      ...
      const path = join(__dirname, '../app/user/templates/advertisement/thankyouNotice.html');
  ...
  async sendEmailAdvertisementNotification( subject, data = {}) {
    try {
      const path = join(__dirname, '../app/user/templates/advertisement/backendEmailNotice.html');
