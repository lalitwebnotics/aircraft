"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = startCron;var _AwsSES = _interopRequireDefault(require("./AwsSES"));
...
function startCron(app, sendAll = false) {
  ...
  try {
    ...
    (0, _Notification.default)(app, ses, sendAll);
...
async function tracksNotifications(app, sendAll) {
  ...
  for (var i = 0; i < allTracks.length; i++) {
    ...
    var last_notified = (0, _moment.default)(track.last_notified);
    ...
    if (productObj != null) {
      ...
      var isModified = (0, _moment.default)(productObj.updated_at) > last_notified;
